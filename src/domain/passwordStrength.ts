/*
 * MIRROR of music-collector-frontend/src/domain/passwordStrength.ts
 *
 * Both apps must agree with each other and with the server's minimum, or one of them will
 * show a full meter for a password the server then refuses. Change all three together.
 */
