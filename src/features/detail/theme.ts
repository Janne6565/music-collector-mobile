/*
 * MIRROR of music-collector-frontend/src/features/detail/theme.ts
 *
 * Both apps must agree on when a sleeve is dark and when an accent is legible, or the same
 * record would look different on phone and desktop. Change both, in the same commit.
 */
